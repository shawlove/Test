...
public class fps_camera : MonoBehaviour {
    ...
    void LateUpdate()
    {
        Quaternion xQuaternion = Quaternion.AngleAxis(y_Angle, Vector3.up);//Quaternion四元数
        Quaternion yQuaternion = Quaternion.AngleAxis(0, Vector3.left);//(-1,0,0)
        m_Transform.parent.rotation = xQuaternion * yQuaternion;//旋转了xQuaternion再旋转yQuaternion 
